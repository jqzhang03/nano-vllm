...
class Qwen3Attention(nn.Module):
    ...
    def __init__(
        ...
        # 如果没有QKV偏置，在Qwen3中则创建Q和K的RMS归一化层
    ...
    def forward(
        ...
        # flatten(start_dim, end_dim)用于将张量的指定连续维度范围展平为一维，这里表示从第一维(base0)到最后一维展平
